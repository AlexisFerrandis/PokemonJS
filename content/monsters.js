...
window.monsters = {
	...
	//         Abilities : INTIMIDATE,SHEDSKIN
	//         HiddenAbility : UNNERVE
	//         Moves : 0,"CRUNCH",1,"CRUNCH",1,ICEFANG,1,"THUNDER"FANG,1,"FIREFANG",1,WRAP,1,LEER,1,"POISONSTING",1,"BITE",4,"POISONSTING",9,"BITE",12,GLARE,17,SCREECH,20,ACID,27,STOCKPILE,27,SWALLOW,27,SPITUP,32,ACIDSPRAY,39,MUDBOMB,44,GASTROACID,48,BELCH,51,"HAZE",56,COIL,63,GUNKSHOT
	...
	//         Abilities : STATIC
	//         HiddenAbility : LIGHTNINGROD
	//         Moves : 1,"THUNDER"SHOCK,1,"TAILWHIP",1,"QUICKATTACK",1,"THUNDER"BOLT
	//         TutorMoves : "ATTRACT","BRICKBREAK","CHARGEBEAM","CONFIDE","COVET","DOUBLETEAM","ECHOEDVOICE","ELECTROWEB","FACADE","FLING","FOCUSBLAST","FOCUSPUNCH","FRUSTRATION","GIGAIMPACT","GRASSKNOT","HELPINGHAND","HIDDENPOWER","HYPERBEAM","IRONTAIL","KNOCKOFF","LASERFOCUS","LIGHTSCREEN","MAGNETRISE","PROTECT","RAINDANCE","REST","RETURN","ROCKSMASH","ROUND","SHOCKWAVE","SIGNALBEAM","SLEEPTALK","SNORE","STRENGTH","SUBSTITUTE","SWAGGER","THIEF","THUNDER","THUNDER"BOLT,""THUNDER"PUNCH","THUNDER"WAVE,"TOXIC",VOLTSWITCH,"WILDCHARGE"
	...
	//         Abilities : INTIMIDATE,FLASHFIRE
	//         HiddenAbility : JUSTIFIED
	//         Moves : 1,"THUNDER"FANG,1,"BITE",1,"ROAR",1,ODORSLEUTH,1,"FIREFANG",34,EXTREMESPEED
	...
	//         TutorMoves : "ATTRACT","BRICKBREAK",BULKUP,"BULLDOZE","CONFIDE","DOUBLETEAM",DUALCHOP,"EARTHQUAKE","FACADE","FIREBLAST","FIREPUNCH","FLAMETHROWER","FLING","FOCUSBLAST","FOCUSPUNCH","FRUSTRATION","HELPINGHAND","HIDDENPOWER","ICEPUNCH","KNOCKOFF","LIGHTSCREEN",LOWKICK,LOWSWEEP,"PAYBACK","POISONJAB","POWERUPPUNCH","PROTECT","RAINDANCE","REST","RETURN","ROCKSLIDE","ROCKSMASH","ROCKTOMB",ROLEPLAY,"ROUND","SLEEPTALK","SMACKDOWN","SNORE","STRENGTH","SUBSTITUTE","SUNNYDAY",SUPERPOWER,"SWAGGER","THIEF",""THUNDER"PUNCH","TOXIC","WORKUP"
	//         EggMoves : BULLETPUNCH,CLOSECOMBAT,"COUNTER",ENCORE,"FIREPUNCH",HEAVYSLAM,"ICEPUNCH","KNOCKOFF",MEDITATE,POWERTRICK,QUICKGUARD,ROLLINGKICK,SMELLINGSALTS,""THUNDER"PUNCH","TICKLE"
	//         Compatibility : Humanlike
	//         StepsToHatch : 5120
	//         Height : 0.8
	//         Weight : 19.5
	...
	//         TutorMoves : "ATTRACT","BRICKBREAK",BULKUP,"BULLDOZE","CONFIDE","DOUBLETEAM",DUALCHOP,"EARTHQUAKE","FACADE","FIREBLAST","FIREPUNCH","FLAMETHROWER","FLING","FOCUSBLAST","FOCUSPUNCH","FRUSTRATION","HELPINGHAND","HIDDENPOWER","ICEPUNCH","KNOCKOFF","LIGHTSCREEN",LOWKICK,LOWSWEEP,"PAYBACK","POISONJAB","POWERUPPUNCH","PROTECT","RAINDANCE","REST","RETURN","ROCKSLIDE","ROCKSMASH","ROCKTOMB",ROLEPLAY,"ROUND","SLEEPTALK","SMACKDOWN","SNORE","STOMPINGTANTRUM","STRENGTH","SUBSTITUTE","SUNNYDAY",SUPERPOWER,"SWAGGER","THIEF",""THUNDER"PUNCH","TOXIC","WORKUP"
	//         Compatibility : Humanlike
	//         StepsToHatch : 5120
	//         Height : 1.5
	//         Weight : 70.5
	...
	//         TutorMoves : "ATTRACT","BRICKBREAK",BULKUP,"BULLDOZE","CONFIDE","DOUBLETEAM",DUALCHOP,"EARTHQUAKE","FACADE","FIREBLAST","FIREPUNCH","FLAMETHROWER","FLING","FOCUSBLAST","FOCUSPUNCH","FRUSTRATION","GIGAIMPACT","HELPINGHAND","HIDDENPOWER","HYPERBEAM","ICEPUNCH","KNOCKOFF","LIGHTSCREEN",LOWKICK,LOWSWEEP,"PAYBACK","POISONJAB","POWERUPPUNCH","PROTECT","RAINDANCE","REST","RETURN","ROCKSLIDE","ROCKSMASH","ROCKTOMB",ROLEPLAY,"ROUND","SLEEPTALK","SMACKDOWN","SNORE","STOMPINGTANTRUM",STONEEDGE,"STRENGTH","SUBSTITUTE","SUNNYDAY",SUPERPOWER,"SWAGGER","THIEF","THROATCHOP",""THUNDER"PUNCH","TOXIC","WORKUP"
	//         Compatibility : Humanlike
	//         StepsToHatch : 5120
	//         Height : 1.6
	//         Weight : 130.0
	...
	//         Habitat : Mountain
	//         Kind : Rock
	//         // Pokedex : They descend from mountains by tumbling down steep slopes. They are so brutal, they smash aside obstructing trees and huge boulders with "thunder"ous "tackle"s.
	//         Generation : 1
	//         WildItemUncommon : EVERSTONE
	//         BattlerPlayerX : -4
	//         BattlerPlayerY : 0
	...
	//         Moves : 1,"SUPERSONIC",1,"TACKLE",5,"THUNDER"SHOCK,7,"THUNDER"WAVE,11,MAGNETBOMB,13,"LIGHTSCREEN",17,SONICBOOM,19,"SPARK",23,MIRRORSHOT,25,METALSOUND,29,"ELECTROBALL",31,"FLASHCANNON",35,SCREECH,37,"DISCHARGE",41,LOCKON,43,"MAGNETRISE",47,"GYROBALL",49,ZAPCANNON
	//         TutorMoves : "CHARGEBEAM","CONFIDE","DOUBLETEAM","ELECTROWEB",EXPLOSION,"FACADE","FLASHCANNON","FRUSTRATION",GRAVITY,"GYROBALL","HIDDENPOWER","IRONDEFENSE","LIGHTSCREEN",MAGICCOAT,"MAGNETRISE","PROTECT","PSYCHUP","RAINDANCE",RECYCLE,REFLECT,"REST","RETURN","ROUND","SHOCKWAVE","SIGNALBEAM","SLEEPTALK","SNORE","SUBSTITUTE","SUNNYDAY","SWAGGER","THUNDER","THUNDER"BOLT,"THUNDER"WAVE,"TOXIC",VOLTSWITCH,"WILDCHARGE"
	//         Compatibility : Mineral
	//         StepsToHatch : 5120
	//         Height : 0.3
	//         Weight : 6.0
	...
	//         Abilities : MAGNETPULL,STURDY
	//         HiddenAbility : ANALYTIC
	//         Moves : 0,TRIATTACK,1,TRIATTACK,1,ELECTRICTERRAIN,1,ZAPCANNON,1,"SUPERSONIC",1,"TACKLE",1,"THUNDER"SHOCK,1,"THUNDER"WAVE,5,"THUNDER"SHOCK,7,"THUNDER"WAVE,11,MAGNETBOMB,13,"LIGHTSCREEN",17,SONICBOOM,19,"SPARK",23,MIRRORSHOT,25,METALSOUND,29,"ELECTROBALL",33,"FLASHCANNON",39,SCREECH,43,"DISCHARGE",49,LOCKON,53,"MAGNETRISE",59,"GYROBALL",63,ZAPCANNON
	...
	//         TutorMoves : "ATTRACT","CONFIDE","DOUBLETEAM",EXPLOSION,"FACADE","FIREBLAST","FIREPUNCH","FLAMETHROWER","FLING","FRUSTRATION","GIGADRAIN",GUNKSHOT,"HIDDENPOWER","ICEPUNCH","INFESTATION",PAINSPLIT,"PAYBACK","POISONJAB","POWERUPPUNCH","PROTECT","RAINDANCE","REST","RETURN","ROCKSLIDE","ROCKTOMB","ROUND","SHADOWBALL","SHOCKWAVE","SLEEPTALK",""SLUDGE"BOMB","SLUDGE"WAVE,"SNORE","STRENGTH","SUBSTITUTE","SUNNYDAY","SWAGGER",TAUNT,"THIEF","THUNDER","THUNDER"BOLT,""THUNDER"PUNCH",TORMENT,"TOXIC","VENOSHOCK"
	...
	//         TutorMoves : "ATTRACT","BLOCK","BRICKBREAK","CONFIDE","DARKPULSE","DOUBLETEAM",EXPLOSION,"FACADE","FIREBLAST","FIREPUNCH","FLAMETHROWER","FLING","FOCUSBLAST","FOCUSPUNCH","FRUSTRATION","GIGADRAIN","GIGAIMPACT",GUNKSHOT,"HIDDENPOWER","HYPERBEAM","ICEPUNCH","INFESTATION",PAINSPLIT,"PAYBACK","POISONJAB","POWERUPPUNCH","PROTECT","RAINDANCE","REST","RETURN","ROCKSLIDE","ROCKSMASH","ROCKTOMB","ROUND","SHADOWBALL","SHOCKWAVE","SLEEPTALK",""SLUDGE"BOMB","SLUDGE"WAVE,"SNORE","STRENGTH","SUBSTITUTE","SUNNYDAY","SWAGGER",TAUNT,"THIEF","THUNDER","THUNDER"BOLT,""THUNDER"PUNCH",TORMENT,"TOXIC","VENOSHOCK"
	//         Compatibility : Amorphous
	//         StepsToHatch : 5120
	//         Height : 1.2
	//         Weight : 30.0
	...
	//         TutorMoves : ALLYSWITCH,"ATTRACT","CONFIDE","DARKPULSE",DAZZLINGGLEAM,"DOUBLETEAM","DREAMEATER",EMBARGO,"ENERGYBALL",EXPLOSION,"FACADE","FIREPUNCH",FOULPLAY,"FRUSTRATION","GIGADRAIN","HIDDENPOWER","ICEPUNCH","ICYWIND","INFESTATION","KNOCKOFF",PAINSPLIT,"PAYBACK","PROTECT","PSYCHIC","PSYCHUP","RAINDANCE","REST","RETURN","ROUND","SHADOWBALL","SKILLSWAP","SLEEPTALK",""SLUDGE"BOMB",SNATCH,"SNORE",SPITE,"SUBSTITUTE","SUNNYDAY","SWAGGER",TAUNT,TELEKINESIS,"THIEF","THUNDER"BOLT,""THUNDER"PUNCH",TORMENT,"TOXIC",TRICK,TRICKROOM,UPROAR,"VENOSHOCK","WILLOWISP",WONDERROOM
	//         EggMoves : ASTONISH,CLEARSMOG,DISABLE,"FIREPUNCH",GRUDGE,"HAZE","ICEPUNCH",PERISHSONG,PSYWAVE,REFLECTTYPE,"SCARYFACE",SMOG,""THUNDER"PUNCH"
	//         Compatibility : Amorphous
	//         StepsToHatch : 5120
	//         Height : 1.3
	//         Weight : 0.1
	...
	//         TutorMoves : ALLYSWITCH,"ATTRACT","CONFIDE","DARKPULSE",DAZZLINGGLEAM,"DOUBLETEAM","DREAMEATER",EMBARGO,"ENERGYBALL",EXPLOSION,"FACADE","FIREPUNCH","FLING",FOULPLAY,"FRUSTRATION","GIGADRAIN","HIDDENPOWER","ICEPUNCH","ICYWIND","INFESTATION","KNOCKOFF",PAINSPLIT,"PAYBACK","POISONJAB","PROTECT","PSYCHIC","PSYCHUP","RAINDANCE","REST","RETURN","ROUND","SHADOWBALL","SHADOWCLAW","SKILLSWAP","SLEEPTALK",""SLUDGE"BOMB",SNATCH,"SNORE",SPITE,"SUBSTITUTE","SUNNYDAY","SWAGGER",TAUNT,TELEKINESIS,"THIEF","THUNDER"BOLT,""THUNDER"PUNCH",TORMENT,"TOXIC",TRICK,TRICKROOM,UPROAR,"VENOSHOCK","WILLOWISP",WONDERROOM
	//         Compatibility : Amorphous
	//         StepsToHatch : 5120
	//         Height : 1.6
	//         Weight : 0.1
	...
	//         Moves : 0,SHADOWPUNCH,1,SHADOWPUNCH,1,HYPNOSIS,1,LICK,1,SPITE,5,SPITE,8,MEANLOOK,12,"CURSE",15,NIGHTSHADE,19,CONFUSERAY,22,SUCKERPUNCH,28,"PAYBACK",33,"SHADOWBALL",39,"DREAMEATER",44,"DARKPULSE",50,DESTINYBOND,55,HEX,61,NIGHTMARE
	//         TutorMoves : ALLYSWITCH,"ATTRACT","BRICKBREAK","CONFIDE","DARKPULSE",DAZZLINGGLEAM,"DOUBLETEAM",DRAINPUNCH,"DREAMEATER",EMBARGO,"ENERGYBALL",EXPLOSION,"FACADE","FIREPUNCH","FLING","FOCUSBLAST","FOCUSPUNCH",FOULPLAY,"FRUSTRATION","GIGADRAIN","GIGAIMPACT","HIDDENPOWER","HYPERBEAM","ICEPUNCH","ICYWIND","INFESTATION","KNOCKOFF","LASERFOCUS",PAINSPLIT,"PAYBACK","POISONJAB","POWERUPPUNCH","PROTECT","PSYCHIC","PSYCHUP","RAINDANCE","REST","RETURN","ROCKSMASH",ROLEPLAY,"ROUND","SHADOWBALL","SHADOWCLAW","SKILLSWAP","SLEEPTALK",""SLUDGE"BOMB",SNATCH,"SNORE",SPITE,"STRENGTH","SUBSTITUTE","SUNNYDAY","SWAGGER",TAUNT,TELEKINESIS,"THIEF","THUNDER","THUNDER"BOLT,""THUNDER"PUNCH",TORMENT,"TOXIC",TRICK,TRICKROOM,UPROAR,"VENOSHOCK","WILLOWISP",WONDERROOM
	//         Compatibility : Amorphous
	//         StepsToHatch : 5120
	//         Height : 1.5
	//         Weight : 40.5
	...
	//         EggMoves : ASSIST,BARRIER,"FIREPUNCH",FLATTER,GUARDSWAP,"ICEPUNCH",NASTYPLOT,POWERSPLIT,PSYCHICTERRAIN,PSYCHOCUT,ROLEPLAY,SECRETPOWER,"SKILLSWAP",""THUNDER"PUNCH"
	//         Compatibility : Humanlike
	//         StepsToHatch : 5120
	//         Height : 1.0
	//         Weight : 32.4
	...
	//         TutorMoves : "CHARGEBEAM","CONFIDE","DOUBLETEAM",EXPLOSION,"FACADE",FOULPLAY,"FRUSTRATION","GYROBALL","HIDDENPOWER","LIGHTSCREEN",MAGICCOAT,"MAGNETRISE","PROTECT","RAINDANCE","REST","RETURN","ROUND","SHOCKWAVE","SIGNALBEAM","SLEEPTALK","SNORE","SUBSTITUTE","SWAGGER",TAUNT,"THIEF","THUNDER","THUNDER"BOLT,"THUNDER"WAVE,TORMENT,"TOXIC",VOLTSWITCH,"WILDCHARGE"
	//         Compatibility : Mineral
	//         StepsToHatch : 5120
	//         Height : 0.5
	//         Weight : 10.4
	...
	//         TutorMoves : "CHARGEBEAM","CONFIDE","DOUBLETEAM",EXPLOSION,"FACADE",FOULPLAY,"FRUSTRATION","GIGAIMPACT","GYROBALL","HIDDENPOWER","HYPERBEAM","LIGHTSCREEN",MAGICCOAT,"MAGNETRISE","PROTECT","RAINDANCE","REST","RETURN","ROUND","SHOCKWAVE","SIGNALBEAM","SLEEPTALK","SNORE","SUBSTITUTE","SWAGGER",TAUNT,TELEKINESIS,"THIEF","THUNDER","THUNDER"BOLT,"THUNDER"WAVE,TORMENT,"TOXIC",VOLTSWITCH,"WILDCHARGE"
	//         Compatibility : Mineral
	//         StepsToHatch : 5120
	//         Height : 1.2
	//         Weight : 66.6
	...
	//         TutorMoves : "AERIALACE","ATTRACT","BLIZZARD","BRICKBREAK","BRUTALSWING","BULLDOZE","CONFIDE","DOUBLETEAM",EARTHPOWER,"EARTHQUAKE","ECHOEDVOICE","ENDEAVOR","FACADE","FALSESWIPE","FIREBLAST","FIREPUNCH","FLAMETHROWER","FLING","FOCUSPUNCH","FRUSTRATION","HIDDENPOWER","ICEBEAM","ICYWIND","IRONDEFENSE",IRONHEAD,"IRONTAIL","KNOCKOFF",LOWKICK,"POWERUPPUNCH","PROTECT","REST","RETURN","ROCKSLIDE","ROCKSMASH","ROCKTOMB","ROUND",SANDSTORM,"SLEEPTALK","SMACKDOWN","SNORE",STEALTHROCK,"STRENGTH","SUBSTITUTE","SUNNYDAY","SWAGGER","SWORDSDANCE","THIEF",""THUNDER"PUNCH","TOXIC",UPROAR
	...
	//         HiddenAbility : INNERFOCUS
	//         Moves : 0,COMETPUNCH,1,COMETPUNCH,1,CLOSECOMBAT,1,"COUNTER",1,"FOCUSPUNCH",1,REVENGE,1,"AGILITY",1,"PURSUIT",1,MACHPUNCH,6,"AGILITY",11,"PURSUIT",16,MACHPUNCH,16,BULLETPUNCH,21,"FEINT",26,VACUUMWAVE,31,QUICKGUARD,36,""THUNDER"PUNCH",36,"ICEPUNCH",36,"FIREPUNCH",41,SKYUPPERCUT,46,MEGAPUNCH,50,"DETECT",56,"FOCUSPUNCH",61,"COUNTER",66,CLOSECOMBAT
	//         TutorMoves : "ATTRACT","BRICKBREAK",BULKUP,"BULLDOZE","CONFIDE","COVET","DOUBLETEAM",DRAINPUNCH,"EARTHQUAKE","FACADE","FIREPUNCH","FLING","FOCUSBLAST","FOCUSPUNCH","FRUSTRATION","HELPINGHAND","HIDDENPOWER","ICEPUNCH","LASERFOCUS",LOWKICK,LOWSWEEP,"POWERUPPUNCH","PROTECT","RAINDANCE","REST","RETURN","ROCKSLIDE","ROCKSMASH","ROCKTOMB",ROLEPLAY,"ROUND","SLEEPTALK","SNORE",STONEEDGE,"STRENGTH","SUBSTITUTE","SUNNYDAY","SWAGGER","THIEF","THROATCHOP",""THUNDER"PUNCH","TOXIC","WORKUP"
	//         Compatibility : Humanlike
	//         StepsToHatch : 6400
	//         Height : 1.4
	//         Weight : 50.2
	...
	//         TutorMoves : "AQUATAIL","ATTRACT","BIND","BLIZZARD","BRICKBREAK","BRUTALSWING","BULLDOZE","CONFIDE","CUT","DOUBLETEAM","DRAGONTAIL","DREAMEATER","EARTHQUAKE","FACADE","FIREBLAST","FIREPUNCH","FLAMETHROWER","FLING","FOCUSPUNCH","FRUSTRATION","GIGAIMPACT","HIDDENPOWER","HYPERBEAM","ICEBEAM","ICEPUNCH","ICYWIND","IRONTAIL","KNOCKOFF","POWERUPPUNCH","PROTECT","PSYCHUP","RAINDANCE","REST","RETURN","ROCKSLIDE","ROCKSMASH","ROCKTOMB","ROUND",SANDSTORM,"SHADOWBALL","SHOCKWAVE","SLEEPTALK","SNORE","SOLARBEAM","STOMPINGTANTRUM","STRENGTH","SUBSTITUTE","SUNNYDAY","SURF","SWAGGER","SWORDSDANCE","THIEF","THUNDER","THUNDER"BOLT,""THUNDER"PUNCH","TOXIC","WATERPULSE","WORKUP","ZENHEADBUTT"
	...
	//         TutorMoves : "ATTRACT","CONFIDE","DARKPULSE","DOUBLETEAM",EXPLOSION,"FACADE","FIREBLAST","FLAMETHROWER","FRUSTRATION","GYROBALL","HIDDENPOWER","INFESTATION",PAINSPLIT,"PAYBACK","PROTECT","RAINDANCE","REST","RETURN","ROUND","SHADOWBALL","SHOCKWAVE","SLEEPTALK",""SLUDGE"BOMB","SNORE",SPITE,"SUBSTITUTE","SUNNYDAY","SWAGGER",TAUNT,"THIEF","THUNDER","THUNDER"BOLT,TORMENT,"TOXIC",UPROAR,"VENOSHOCK","WILLOWISP"
	...
	//         TutorMoves : "ATTRACT","CONFIDE","DARKPULSE","DOUBLETEAM",EXPLOSION,"FACADE","FIREBLAST","FLAMETHROWER","FRUSTRATION","GIGAIMPACT","GYROBALL","HIDDENPOWER","HYPERBEAM","INFESTATION",PAINSPLIT,"PAYBACK","PROTECT","RAINDANCE","REST","RETURN","ROUND","SHADOWBALL","SHOCKWAVE","SLEEPTALK",""SLUDGE"BOMB","SNORE",SPITE,"SUBSTITUTE","SUNNYDAY","SWAGGER",TAUNT,"THIEF","THUNDER","THUNDER"BOLT,TORMENT,"TOXIC",UPROAR,"VENOSHOCK","WILLOWISP"
	//         Compatibility : Amorphous
	//         StepsToHatch : 5120
	//         Height : 1.2
	//         Weight : 9.5
	...
	//         TutorMoves : "AERIALACE","AQUATAIL","ATTRACT","BLIZZARD","BRICKBREAK","BULLDOZE","CONFIDE","COVET","CUT","DOUBLETEAM",DRAINPUNCH,"EARTHQUAKE","ENDEAVOR","FACADE","FIREBLAST","FIREPUNCH","FLAMETHROWER","FLING","FOCUSBLAST","FOCUSPUNCH","FRUSTRATION","GIGAIMPACT","HAIL","HELPINGHAND","HIDDENPOWER","HYPERBEAM","ICEBEAM","ICEPUNCH","ICYWIND","IRONTAIL",LOWKICK,"OUTRAGE","POWERUPPUNCH","PROTECT","RAINDANCE","REST","RETURN","ROAR","ROCKSLIDE","ROCKSMASH","ROCKTOMB","ROUND","SAFEGUARD",SANDSTORM,"SHADOWBALL","SHADOWCLAW","SHOCKWAVE","SLEEPTALK","SNORE","SOLARBEAM",SPITE,"STRENGTH","SUBSTITUTE","SUNNYDAY","SURF","SWAGGER","THIEF","THUNDER","THUNDER"BOLT,""THUNDER"PUNCH","TOXIC",UPROAR,"WATERPULSE","WORKUP"
	...
	//         TutorMoves : "BLIZZARD","CONFIDE",DAZZLINGGLEAM,"DIVE","DOUBLETEAM","FACADE","FLASHCANNON","FRUSTRATION",GRAVITY,"GYROBALL","HAIL","HIDDENPOWER","ICEBEAM","ICYWIND","LIGHTSCREEN",MAGICCOAT,PAINSPLIT,"PROTECT","PSYCHIC","PSYCHUP","RAINDANCE",RECYCLE,REFLECT,"REST","RETURN","ROUND","SCALD","SIGNALBEAM","SLEEPTALK","SNORE","SUBSTITUTE","SURF","SWAGGER","THUNDER","THUNDER"BOLT,"THUNDER"WAVE,"TOXIC","WATERFALL","WATERPULSE"
	//         Compatibility : Water3
	//         StepsToHatch : 5120
	//         Height : 0.8
	//         Weight : 34.5
	...
	//         Moves : 1,"QUICKATTACK",1,LEER,1,"THUNDER"SHOCK,5,"THUNDER"SHOCK,8,LOWKICK,12,"SWIFT",15,"SHOCKWAVE",19,"THUNDER"WAVE,22,"ELECTROBALL",26,"LIGHTSCREEN",29,""THUNDER"PUNCH",36,"DISCHARGE",42,SCREECH,49,"THUNDER"BOLT,55,"THUNDER"
	//         TutorMoves : "ATTRACT","BRICKBREAK","CHARGEBEAM","CONFIDE","COVET","DOUBLETEAM",DUALCHOP,"ELECTROWEB","FACADE","FIREPUNCH","FLING","FOCUSBLAST","FOCUSPUNCH","FRUSTRATION","GIGAIMPACT","HELPINGHAND","HIDDENPOWER","HYPERBEAM","ICEPUNCH","IRONTAIL","LIGHTSCREEN",LOWKICK,LOWSWEEP,"MAGNETRISE","POWERUPPUNCH","PROTECT","PSYCHIC","RAINDANCE","REST","RETURN","ROCKSMASH","ROUND","SHOCKWAVE","SIGNALBEAM","SLEEPTALK","SNORE","STRENGTH","SUBSTITUTE","SWAGGER","THIEF","THUNDER","THUNDER"BOLT,""THUNDER"PUNCH","THUNDER"WAVE,"TOXIC",VOLTSWITCH,"WILDCHARGE"
	//         Compatibility : Humanlike
	//         StepsToHatch : 6400
	//         Height : 1.1
	//         Weight : 30.0
	...
	//         Moves : 0,"THUNDER"SHOCK,1,"THUNDER"SHOCK,1,"HELPINGHAND",1,"TACKLE",1,"TAILWHIP",5,"SANDATTACK",9,"BABYDOLLEYES",13,"QUICKATTACK",17,DOUBLEKICK,20,"THUNDER"FANG,25,"PINMISSILE",29,"AGILITY",33,"THUNDER"WAVE,37,"DISCHARGE",41,"LASTRESORT",45,"THUNDER"
	//         TutorMoves : "ATTRACT","CHARGEBEAM","CONFIDE","COVET","DOUBLETEAM","ECHOEDVOICE","FACADE","FRUSTRATION","GIGAIMPACT","HEALBELL","HELPINGHAND","HIDDENPOWER","HYPERBEAM","HYPERVOICE","IRONTAIL","LASERFOCUS","LASTRESORT","LIGHTSCREEN","MAGNETRISE","PROTECT","RAINDANCE","REST","RETURN","ROAR","ROCKSMASH","ROUND","SHADOWBALL","SHOCKWAVE","SIGNALBEAM","SLEEPTALK","SNORE","STRENGTH","SUBSTITUTE","SUNNYDAY","SWAGGER","THUNDER","THUNDER"BOLT,"THUNDER"WAVE,"TOXIC",VOLTSWITCH,"WILDCHARGE","WORKUP"
	//         Compatibility : Field
	//         StepsToHatch : 8960
	//         Height : 0.8
	//         Weight : 24.5
	...
	//         Habitat : Urban
	//         Kind : Lightning
	//         // Pokedex : Its cells generate weak power that is amplified by its fur's static electricity to drop "thunder"bolts. The bristling fur is made of electrically charged needles.
	//         Generation : 1
	//         BattlerPlayerX : -4
	//         BattlerPlayerY : 0
	//         BattlerEnemyX : -2
	...
	//         TutorMoves : "AERIALACE",ALLYSWITCH,"BLIZZARD","CHARGEBEAM","CONFIDE","DOUBLETEAM","DREAMEATER","ELECTROWEB","FACADE",FOULPLAY,"FRUSTRATION","GIGAIMPACT",GRAVITY,"HIDDENPOWER","HYPERBEAM","ICEBEAM","ICYWIND","IRONTAIL","LASTRESORT",MAGICCOAT,"MAGNETRISE",PAINSPLIT,"PROTECT","PSYCHIC","PSYCHUP",PSYSHOCK,"RAINDANCE",RECYCLE,"REST","RETURN","ROUND","SHADOWBALL","SHOCKWAVE","SIGNALBEAM","SLEEPTALK","SNORE","SOLARBEAM","SUBSTITUTE","SUNNYDAY","SWAGGER",TELEKINESIS,"THIEF","THUNDER","THUNDER"BOLT,"THUNDER"WAVE,"TOXIC",TRICK,TRICKROOM,WONDERROOM,"ZENHEADBUTT"
	//         Compatibility : Mineral
	//         StepsToHatch : 5120
	//         Height : 0.8
	//         Weight : 36.5
	...
	//         HiddenAbility : UNNERVE
	//         Moves : 1,IRONHEAD,1,ICEFANG,1,"FIREFANG",1,"THUNDER"FANG,1,"WINGATTACK",1,"SUPERSONIC",1,"BITE",1,"SCARYFACE",9,"ROAR",17,"AGILITY",25,"ANCIENTPOWER",33,"CRUNCH",41,"TAKEDOWN",49,"SKYDROP",57,IRONHEAD,65,"HYPERBEAM",73,"ROCKSLIDE",81,"GIGAIMPACT"
	...
	//         TutorMoves : AFTERYOU,"ATTRACT","BLIZZARD","BLOCK","BRICKBREAK","BULLDOZE","CONFIDE","COVET","DOUBLETEAM","EARTHQUAKE","FACADE","FIREBLAST","FIREPUNCH","FLAMETHROWER","FLING","FOCUSBLAST","FOCUSPUNCH","FRUSTRATION","GIGAIMPACT",GUNKSHOT,"HIDDENPOWER","HYPERBEAM","HYPERVOICE","ICEBEAM","ICEPUNCH","ICYWIND",IRONHEAD,"LASTRESORT","OUTRAGE","POWERUPPUNCH","PROTECT","PSYCHIC","RAINDANCE",RECYCLE,"REST","RETURN","ROCKSLIDE","ROCKSMASH","ROCKTOMB","ROUND",SANDSTORM,"SEEDBOMB","SHADOWBALL","SHOCKWAVE","SLEEPTALK","SMACKDOWN",SNATCH,"SNORE","SOLARBEAM","STOMPINGTANTRUM","STRENGTH","SUBSTITUTE","SUNNYDAY",SUPERPOWER,"SURF","SWAGGER","THUNDER","THUNDER"BOLT,""THUNDER"PUNCH","TOXIC","WATERPULSE","WILDCHARGE","WORKUP","ZENHEADBUTT"
	...
	//         Moves : 1,PECK,1,"THUNDER"SHOCK,8,"THUNDER"WAVE,15,"DETECT",22,PLUCK,29,"ANCIENTPOWER",36,CHARGE,43,"AGILITY",50,"DISCHARGE",57,"RAINDANCE",64,"LIGHTSCREEN",71,DRILLPECK,78,"THUNDER",85,"ROOST",92,MAGNETICFLUX,99,ZAPCANNON
	//         TutorMoves : "AERIALACE","CHARGEBEAM","CONFIDE","DEFOG","DOUBLETEAM","FACADE","FLY","FRUSTRATION","GIGAIMPACT","HEATWAVE","HIDDENPOWER","HYPERBEAM","LASERFOCUS","LIGHTSCREEN","PROTECT","RAINDANCE","REST","RETURN","ROAR","ROCKSMASH","ROOST","ROUND",SANDSTORM,"SHOCKWAVE","SIGNALBEAM",SKYATTACK,"SKYDROP","SLEEPTALK","SNORE","STEELWING","SUBSTITUTE","SUNNYDAY","SWAGGER","TAILWIND","THUNDER","THUNDER"BOLT,"THUNDER"WAVE,"TOXIC","UTURN",VOLTSWITCH,"WILDCHARGE"
	//         Compatibility : Undiscovered
	//         StepsToHatch : 20480
	//         Height : 1.6
	//         Weight : 52.6
	...
	//         Habitat : Rare
	//         Kind : Electric
	//         // Pokedex : Zapdos is a legendary bird Pokémon that has the ability to control electricity. It usually lives in "thunder"clouds. It gains power if it is stricken by lightning bolts.
	//         Generation : 1
	//         BattlerPlayerX : 5
	//         BattlerPlayerY : 0
	//         BattlerEnemyX : 0
	...
	//         Moves : 1,WRAP,1,LEER,5,"THUNDER"WAVE,11,TWISTER,15,"DRAGONRAGE",21,"SLAM",25,"AGILITY",31,"DRAGONTAIL",35,"AQUATAIL",41,"DRAGONRUSH",45,"SAFEGUARD",51,"DRAGONDANCE",55,"OUTRAGE",61,"HYPERBEAM"
	//         TutorMoves : "AQUATAIL","ATTRACT","BIND","BLIZZARD","BRUTALSWING","CONFIDE","DOUBLETEAM",DRACOMETEOR,"DRAGONPULSE","DRAGONTAIL","FACADE","FIREBLAST","FLAMETHROWER","FRUSTRATION","HAIL","HIDDENPOWER","HYPERBEAM","ICEBEAM","ICYWIND","IRONTAIL","LIGHTSCREEN","OUTRAGE","PROTECT","RAINDANCE","REST","RETURN","ROUND","SAFEGUARD","SHOCKWAVE","SLEEPTALK","SNORE","SUBSTITUTE","SUNNYDAY","SURF","SWAGGER","THUNDER","THUNDER"BOLT,"THUNDER"WAVE,"TOXIC","WATERFALL","WATERPULSE"
	...
	//         Abilities : SHEDSKIN
	//         HiddenAbility : MARVELSCALE
	//         Moves : 1,WRAP,1,LEER,1,"THUNDER"WAVE,1,TWISTER,5,"THUNDER"WAVE,11,TWISTER,15,"DRAGONRAGE",21,"SLAM",25,"AGILITY",33,"DRAGONTAIL",39,"AQUATAIL",47,"DRAGONRUSH",53,"SAFEGUARD",61,"DRAGONDANCE",67,"OUTRAGE",75,"HYPERBEAM"
	//         TutorMoves : "AQUATAIL","ATTRACT","BIND","BLIZZARD","BRUTALSWING","CONFIDE","DOUBLETEAM",DRACOMETEOR,"DRAGONPULSE","DRAGONTAIL","FACADE","FIREBLAST","FLAMETHROWER","FRUSTRATION","HAIL","HIDDENPOWER","HYPERBEAM","ICEBEAM","ICYWIND","IRONTAIL","LIGHTSCREEN","OUTRAGE","PROTECT","RAINDANCE","REST","RETURN","ROUND","SAFEGUARD","SHOCKWAVE","SLEEPTALK","SNORE","SUBSTITUTE","SUNNYDAY","SURF","SWAGGER","THUNDER","THUNDER"BOLT,"THUNDER"WAVE,"TOXIC","WATERFALL","WATERPULSE"
	//         Compatibility : Water1,Dragon
	//         StepsToHatch : 10240
	//         Height : 4.0
	...
	//         Moves : 0,"WINGATTACK",1,"WINGATTACK",1,HURRICANE,1,"FIREPUNCH",1,""THUNDER"PUNCH",1,"ROOST",1,WRAP,1,LEER,1,"THUNDER"WAVE,1,TWISTER,5,"THUNDER"WAVE,11,TWISTER,15,"DRAGONRAGE",21,"SLAM",25,"AGILITY",33,"DRAGONTAIL",39,"AQUATAIL",47,"DRAGONRUSH",53,"SAFEGUARD",61,"DRAGONDANCE",67,"OUTRAGE",75,"HYPERBEAM",81,HURRICANE
	//         TutorMoves : "AERIALACE","AQUATAIL","ATTRACT","BIND","BLIZZARD","BRICKBREAK","BRUTALSWING","BULLDOZE","CONFIDE","CUT","DEFOG","DIVE","DOUBLETEAM",DRACOMETEOR,"DRAGONCLAW","DRAGONPULSE","DRAGONTAIL","EARTHQUAKE","FACADE","FIREBLAST","FIREPUNCH","FLAMETHROWER","FLING","FLY","FOCUSBLAST","FOCUSPUNCH","FRUSTRATION","GIGAIMPACT","HAIL","HEATWAVE","HIDDENPOWER","HYPERBEAM","ICEBEAM","ICEPUNCH","ICYWIND",IRONHEAD,"IRONTAIL","LIGHTSCREEN","OUTRAGE","POWERUPPUNCH","PROTECT","RAINDANCE","REST","RETURN","ROAR","ROCKSLIDE","ROCKSMASH","ROCKTOMB","ROOST","ROUND","SAFEGUARD",SANDSTORM,"SHOCKWAVE","SKYDROP","SLEEPTALK","SNORE","STEELWING",STONEEDGE,"STRENGTH","SUBSTITUTE","SUNNYDAY",SUPERPOWER,"SURF","SWAGGER","TAILWIND","THUNDER","THUNDER"BOLT,""THUNDER"PUNCH","THUNDER"WAVE,"TOXIC","WATERFALL","WATERPULSE"
	//         Compatibility : Water1,Dragon
	//         StepsToHatch : 10240
	//         Height : 2.2
	//         Weight : 210.0
